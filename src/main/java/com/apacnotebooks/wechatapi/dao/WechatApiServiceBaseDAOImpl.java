package com.apacnotebooks.wechatapi.dao;
...
import com.apacnotebooks.wechatapi.web.util.ReflectionUtils;

@SuppressWarnings("unchecked")
public class WechatApiServiceBaseDAOImpl<T, PK extends Serializable> implements IWechatApiServiceBaseDAO<T, PK> {
	
	protected static Logger logger = LoggerFactory.getLogger(WechatApiServiceBaseDAOImpl.class);
	...
	public WechatApiServiceBaseDAOImpl() {
